...
class Contact extends Component {
    ...
    validateForm = (event) => {
        ...
        const mailtoLink = `mailto:thirunavukarasuvsr@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
                            ...
                            <div className="project-container" id="mail">
                                <div className="row">
                                    <div className="col-sm-8 offset-md-2">
                                        <form className="justify-content-center" onSubmit={this.validateForm}>
                                            <div className="form-group form-group-lg">
                                                ...
                                                <input name="subject" type="text" id='subject' className="form-control" required onChange={this.handleInputChange} />
                                            ...
                                            <div className="form-group form-group-lg">
                                                ...
                                                <textarea name="body" id='body' className="form-control" rows="5" required onChange={this.handleInputChange} />

                                            </div>
                                            <input type="submit" value="send" id="navigation" className="btn btn-success" />
                                        </form>
