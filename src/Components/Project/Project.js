...
const ProjectTable = React.memo(
  ({ projectName, languages, githubLink, aboutProject }) => (
...
const Project = () => {
  const projects = [
    ...
    },
    {
      ...
      aboutProject:
        'This is an initial level chat bot which makes use of pre-defined intents to train and understands the entire data. Which is then trained using Neural Network. The messages are classified and tested with the intents. This bot helps customers in ordering their food based on the availability and interests.',
    },
    {
      ...
      aboutProject:
        'The ultimate aim of this sales forecasting website is to allow users to input sales data for a specific period, which will be analyzed using an ARIMA model to provide sales predictions for the next 6 to 12 months. Users can create accounts for personalized access, and the uploaded data will be stored in MongoDB for future analysis. Real-time sales data tracking will be accomplished using PowerBI to compare current and forecasted results.',
    },
  ];
